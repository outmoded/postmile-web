...
exports.form = function (request, reply) {
    ...
    this.api.call('GET', '/invite/public', '', null, function (err, code, payload) {
...
exports.register = function (request, reply) {
    ...
    this.api.clientCall('PUT', '/user' + (request.payload.invite ? '?invite=' + encodeURIComponent(request.payload.invite) : ''), registration, function (err, code, payload) {
        ...
        Login.loginCall(self, signup.network, signup.id, request, '/welcome', null, reply);
    });
};
...
exports.i = function (request, reply) {
    ...
    this.api.call('GET', '/invite/' + request.params.id, '', null, function (err, code, payload) {
...
exports.claim = function (request, reply) {
    ...
    this.api.call('POST', '/invite/' + inviteSession.code + '/claim', '', request.auth.credentials, function (err, code, payload) {
...
exports.inviteRegister = function (request, reply) {
    ...
    this.api.clientCall('PUT', '/user?invite=' + encodeURIComponent(inviteSession.code), registration, function (err, code, payload) {
        ...
        Login.loginCall(self, 'id', payload.id, request, '/view/' + (inviteSession.about.project ? '#project=' + inviteSession.about.project : ''), null, reply);
    });
};
