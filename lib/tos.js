...
exports.post = function (request, reply) {
    ...
    this.api.clientCall('POST', '/user/' + request.auth.credentials.profile.id + '/tos/' + exports.currentTOS, '', function (err, code, payload) {

        // Refresh token

        Session.refresh(self.api, request, request.auth.credentials, function (err, session) {
