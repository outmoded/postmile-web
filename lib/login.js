    ...
    var facebook = function () {
        ...
        if (!request.query.code) {
            var request = {
                ...
                query: {
                    client_id: self.config.login.facebook.clientId,
                    response_type: 'code',
                    scope: 'email',
        ...
        var query = {
            client_id: self.config.login.facebook.clientId,
            client_secret: self.config.login.facebook.clientSecret,
    ...
    var yahoo = function () {
        ...
        if (!request.server.app.yahooClient) {
            request.server.app.yahooClient = new OAuth.OAuth('https://oauth03.member.mud.yahoo.com/oauth/v2/get_request_token',
                                                    ...
                                                    self.config.login.yahoo.clientId,
                                                    self.config.login.yahoo.clientSecret,
                                                    '1.0',
